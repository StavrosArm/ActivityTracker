    ...
    public void run(){
            ...
            try {
                while(true) {
                    ...
                    File file=new File("C:\\Users\\stavr\\IdeaProjects\\DistributedSystems\\%s.txt",NameOfFile);
                    ...
                    System.out.println("---------------------------------------------------");
                    System.out.println("Total Distance: " +Reduced.get(0)+" km");
                    System.out.println("Total Elevation: " +Reduced.get(1)+" m");
                    System.out.println("Average speed of Route: " +Reduced.get(2)+" km/h");
                    System.out.println("Total time: " +Reduced.get(3)/60+"minutes");
                    ...
                    synchronized (UserTotals){
                        ...
                        synchronized (stats){
                            ...
                            Map<Integer,Double> AverageOfUser=stats.User(creator);
                            Map<Integer,Double> TotalAverage=stats.TotalAverage();
                            objectOutputStream.writeObject(AverageOfUser);
                            objectOutputStream.flush();
                            objectOutputStream.writeObject(TotalAverage);
                            objectOutputStream.flush();
                            stats.notifyAll();
                        }
